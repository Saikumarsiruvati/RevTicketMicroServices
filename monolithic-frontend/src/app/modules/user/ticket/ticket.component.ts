    ...
    this.bookingService.getBookingDetails(bookingId).subscribe({
      next: (details: any) => {
        ...
        this.booking = {
          ...
          qrCode: 'QR-' + details.bookingId,
          show: {
            showTime: details.showTime,
            event: {
              title: details.movieName,
              language: details.movieLanguage,
              genreOrType: details.movieGenre,
              posterUrl: details.moviePoster,
              rating: details.movieRating
            },
            venue: {
